    ...
    <div class="">
        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form id="demo-form2" method="post" action="{{ route('admin.semesters.update', $semester->id) }}"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input id="start_time" name="start_time" class="date-picker form-control" placeholder="dd-mm-yyyy"
                                    ...
                                    onmouseout="timeFunctionLong(this)" value="{{ $semester->start_time }}">
                                <script>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input id="end_time" name="end_time" class="date-picker form-control" placeholder="dd-mm-yyyy"
                                    type="text" required="required" type="text" onfocus="this.type='date'"
                                    onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'"
                                    onmouseout="timeFunctionLong(this)" value="{{ $semester->end_time }}">
                                <script>
                                    function timeFunctionLong(input) {
                                        setTimeout(function() {
                                            input.type = 'text';
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <select class="form-control" name="school_year_id">
                                    ...
                                    <option @if($school->id == $semester->school_year_id) selected @endif value="{{ $school->id }}">{{ $school->code }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
